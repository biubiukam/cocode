...
/** Right-edge overflow indicator for a clipped transcript. */
export const SCROLLBAR_COLUMNS = 1;

export function messageContentColumns(
  maxColumns: number | undefined,
): number | undefined {
  return maxColumns === undefined
    ? undefined
    : Math.max(1, maxColumns - MESSAGE_CHROME);
}
