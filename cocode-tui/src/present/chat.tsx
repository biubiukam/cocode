...
export function Chat(props: {
  ...
  const resumeItems =
    snap.resumePicker === undefined
      ? []
      : visibleResumeItems(snap.resumePicker);
  ...
  const actionMenuItems = commandPaletteOpen
    ? commandPaletteItems
    : messageActionItems;
      ...
      if (commandArgumentOpen && commandArgumentState !== undefined) {
        ...
        if (index !== undefined) {
          ...
          if (isPress) {
            ...
            if (item !== undefined)
              dispatchCommandArgumentCompletion(app, item);
          }
        }
        return;
      }
