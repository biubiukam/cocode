	...
	factory: (require) => {
		...
		function AccountAction({ wide, store, providers }) {
			...
			const entries = signedIn ? [
				{
					type: "label",
					id: "identity",
					text: snapshot.profile?.email ?? primary
				},
				{
					id: "account",
					label: t.accountPlan,
			...
			return (0, react.createElement)(react.Fragment, null, (0, react.createElement)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
				...
				onSelect: select,
				className: `${account_module_css_default.actionRoot} ${wide ? "" : account_module_css_default.actionRootRail}`,
