...
import type { TuiCommandLineToolStatus } from './desktop-api.types.ts'

export type CommandLineSectionProps = PropsRuntime<'settings.section'>

export function CommandLineSection(): JSX.Element {
	const api = window.desktopApi?.tui
