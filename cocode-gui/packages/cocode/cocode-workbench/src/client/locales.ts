...
export const zh = {
  ...
  "git.stash": "贮藏",
  "git.stashPush": "贮藏更改",
  "git.stashPushUntracked": "贮藏更改（含未跟踪）",
  "git.stashPop": "弹出贮藏…",
  "git.stashApply": "应用贮藏…",
  "git.stashDrop": "删除贮藏…",
  "git.history": "提交历史",
  ...
  "git.generateMessage": "用模型生成提交信息",

  "settings.nav": "工作台",
  "settings.commitModel": "提交信息模型",
  "settings.commitModelHint": "源代码管理面板里生成提交信息时使用的模型。",
  ...
  "git.confirmDiscard": "确定放弃对 {name} 的更改吗？此操作无法撤销。",
  "git.confirmDiscardAll": "确定放弃全部 {count} 处更改吗？此操作无法撤销。",
  "git.confirmStashDrop": "确定删除该贮藏吗？",
  ...
  "git.promptStashMessage": "贮藏说明（可选）",
...
export const en: Record<WorkbenchKey, string> = {
  ...
  "settings.commitModel": "Commit message model",
  "settings.commitModelHint": "The model used to generate commit messages in Source Control.",
