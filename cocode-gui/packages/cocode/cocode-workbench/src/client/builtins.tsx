...
import { FilesIcon, GitIcon, TerminalIcon } from "./icons.tsx"
...
export function builtInPanels(): readonly WorkbenchPanelDescriptor[] {
  return [
    ...
    { id: "preview", title: () => t("panel.preview"), defaultDock: "right", addable: false, order: 20, render: props => <PreviewPanel {...props} /> },
    { id: "git", title: () => t("panel.git"), icon: <GitIcon size={15} />, defaultDock: "right", singleton: true, order: 30, render: props => <GitPanel {...props} /> },
    { id: "jobs", title: () => t("panel.jobs"), defaultDock: "bottom", singleton: true, order: 40, render: props => <JobsPanel {...props} /> },
    ...
    { id: "browser", title: () => t("panel.browser"), defaultDock: "bottom", order: 60, render: props => <BrowserPanel {...props} /> },
    { id: "subagents", title: () => t("panel.subagents"), defaultDock: "right", singleton: true, order: 70, render: props => <SubagentsPanel {...props} /> },
  ]
}
