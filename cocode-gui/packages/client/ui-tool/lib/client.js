window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region packages/client/ui-tool/src/client/tool/models/tool-call-model.ts
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-tool/src/client/tool/models/read-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-tool/src/client/tool/models/diff-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-tool/src/client/tool/models/search-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-tool/src/client/tool/models/terminal-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-tool/src/client/tool/models/web-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-tool/src/client/tool/components/ToolRow.module.css.mjs
		const css$3 = ".wJH4_a_root{flex-direction:column;display:flex}.wJH4_a_row{position:relative;overflow:hidden}.wJH4_a_root[data-state=running] .wJH4_a_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite wJH4_a_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes wJH4_a_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.wJH4_a_leading{flex-shrink:0}.wJH4_a_root[data-tool^=cordis_] .wJH4_a_leading,.wJH4_a_root[data-tool^=cordis_] .wJH4_a_title{color:var(--dsw-alias-state-business-primary)}.wJH4_a_root[data-tool^=cordis_] .wJH4_a_title{font-weight:500}.wJH4_a_root[data-tool^=cordis_] .wJH4_a_sep{background:var(--dsw-alias-state-business-primary)}.wJH4_a_chevron{color:var(--dsw-alias-label-secondary)}.wJH4_a_title{font-weight:400}.wJH4_a_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.wJH4_a_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.wJH4_a_summarySuffix{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px;font-size:14px;line-height:24px}.wJH4_a_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-state-business-primary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;font-size:14px;line-height:24px;overflow:hidden}.wJH4_a_fileLink:hover{color:var(--dsw-alias-state-business-primary);text-decoration-color:currentColor}.wJH4_a_errorSummary{color:var(--dsw-alias-state-error-primary)}.wJH4_a_bodyWrap{flex-direction:column;display:flex}.wJH4_a_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.wJH4_a_root:hover .wJH4_a_inspectButton,.wJH4_a_inspectButton:focus-visible{opacity:1}.wJH4_a_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.wJH4_a_bodyScroll{max-height:260px;overflow-y:auto}.wJH4_a_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.wJH4_a_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.wJH4_a_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.wJH4_a_ioSection::-webkit-scrollbar-track{margin:6px 0}.wJH4_a_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.wJH4_a_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.wJH4_a_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.wJH4_a_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.wJH4_a_codeBody,.wJH4_a_terminalBody,.wJH4_a_diffBody,.wJH4_a_readBody,.wJH4_a_searchBody,.wJH4_a_webBody{margin:4px 0 4px 4px}.wJH4_a_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.wJH4_a_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.wJH4_a_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}.wJH4_a_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"sep": "wJH4_a_sep",
			"ioLabel": "wJH4_a_ioLabel",
			"dsh-tool-row-sweep": "wJH4_a_dsh-tool-row-sweep",
			"summary": "wJH4_a_summary",
			"readBody": "wJH4_a_readBody",
			"searchBody": "wJH4_a_searchBody",
			"ioDivider": "wJH4_a_ioDivider",
			"terminalBody": "wJH4_a_terminalBody",
			"searchRecovery": "wJH4_a_searchRecovery",
			"summarySuffix": "wJH4_a_summarySuffix",
			"title": "wJH4_a_title",
			"fileLink": "wJH4_a_fileLink",
			"ioCard": "wJH4_a_ioCard",
			"leading": "wJH4_a_leading",
			"webBody": "wJH4_a_webBody",
			"diffBody": "wJH4_a_diffBody",
			"visuallyHidden": "wJH4_a_visuallyHidden",
			"bodyWrap": "wJH4_a_bodyWrap",
			"inspectButton": "wJH4_a_inspectButton",
			"errorSummary": "wJH4_a_errorSummary",
			"ioSection": "wJH4_a_ioSection",
			"root": "wJH4_a_root",
			"ioText": "wJH4_a_ioText",
			"row": "wJH4_a_row",
			"codeBody": "wJH4_a_codeBody",
			"chevron": "wJH4_a_chevron",
			"bodyScroll": "wJH4_a_bodyScroll"
		};
		//#endregion
		//#region packages/client/ui-tool/src/client/tool/components/ToolRow.tsx
		...
		*  summary already describe a settled row). */
		...
		//#endregion
		//#region packages/client/ui-tool/src/client/tool/toolviews/GenericToolCard.tsx
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-tool/src/client/tool/ToolCallTree.module.css.mjs
		const css$2 = ".xc7Saq_callRow{border-radius:6px}.xc7Saq_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"subCalls": "xc7Saq_subCalls",
			"callRow": "xc7Saq_callRow"
		};
		//#endregion
		//#region packages/client/ui-tool/src/client/tool/ToolCallTree.tsx
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-tool/src/client/tool/ToolDetails.module.css.mjs
		const css$1 = ".T5FEPG_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.T5FEPG_cardBody{margin:0}.T5FEPG_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.T5FEPG_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.T5FEPG_code[data-error]{color:var(--dsw-alias-state-error-primary)}.T5FEPG_read,.T5FEPG_web{margin:0}.T5FEPG_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			"web": "T5FEPG_web",
			"empty": "T5FEPG_empty",
			"cardBody": "T5FEPG_cardBody",
			"recovery": "T5FEPG_recovery",
			"code": "T5FEPG_code",
			"read": "T5FEPG_read",
			"description": "T5FEPG_description"
		};
		//#endregion
		//#region packages/client/ui-tool/src/client/tool/ToolDetails.tsx
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-tool/src/client/locale.ts
		/** Locale namespace supplied by the conversation owner to Tool renderers. */
		const CONVERSATION_NS = "conversation";
		//#endregion
		//#region packages/client/ui-tool/src/client/tool/toolviews/ask-question-row.tsx
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.module.css.mjs
		const css = ".UNKFXa_card{flex-direction:column;display:flex}.UNKFXa_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.UNKFXa_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.UNKFXa_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.UNKFXa_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.UNKFXa_ioSection::-webkit-scrollbar-track{margin:6px 0}.UNKFXa_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.UNKFXa_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.UNKFXa_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.UNKFXa_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.UNKFXa_root[data-expandable]{cursor:pointer}.UNKFXa_root{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.UNKFXa_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite UNKFXa_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes UNKFXa_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.UNKFXa_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.UNKFXa_chevron{color:var(--dsw-alias-label-secondary)}.UNKFXa_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.UNKFXa_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.UNKFXa_root:hover .UNKFXa_iconIdle{opacity:0}.UNKFXa_root:hover .UNKFXa_chevronHover{opacity:1}.UNKFXa_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.UNKFXa_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.UNKFXa_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.UNKFXa_errorSummary{color:var(--dsw-alias-state-error-primary)}.UNKFXa_bodyWrap{flex-direction:column;display:flex}.UNKFXa_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.UNKFXa_card:hover .UNKFXa_inspectButton,.UNKFXa_inspectButton:focus-visible{opacity:1}.UNKFXa_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.UNKFXa_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"chevronHover": "UNKFXa_chevronHover",
			"ioSection": "UNKFXa_ioSection",
			"chevron": "UNKFXa_chevron",
			"root": "UNKFXa_root",
			"errorSummary": "UNKFXa_errorSummary",
			"iconIdle": "UNKFXa_iconIdle",
			"ioText": "UNKFXa_ioText",
			"bodyWrap": "UNKFXa_bodyWrap",
			"sep": "UNKFXa_sep",
			"dsh-bash-row-sweep": "UNKFXa_dsh-bash-row-sweep",
			"title": "UNKFXa_title",
			"inspectButton": "UNKFXa_inspectButton",
			"terminal": "UNKFXa_terminal",
			"ioCard": "UNKFXa_ioCard",
			"card": "UNKFXa_card",
			"ioDivider": "UNKFXa_ioDivider",
			"leading": "UNKFXa_leading",
			"visuallyHidden": "UNKFXa_visuallyHidden",
			"summary": "UNKFXa_summary",
			"ioLabel": "UNKFXa_ioLabel"
		};
		//#endregion
		//#region packages/client/ui-tool/src/client/tool/toolviews/bash-sample.tsx
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-tool/src/client/tool/toolviews/file-mutation-row.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-tool/src/client/tool/toolviews/read-row.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-tool/src/client/tool/toolviews/search-row.tsx
		const SEARCH_TITLES = {
			grep: "Grep",
			glob: "Glob"
		};
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-tool/src/client/tool/toolviews/plan-summary.ts
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-tool/src/client/tool/toolviews/todo-row.tsx
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-tool/src/client/tool/toolviews/web-row.tsx
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-tool/src/client/apply.ts
