window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region packages/client/ui-model-selection/src/client/directory.ts
		...
		//#endregion
		//#region packages/client/ui-model-selection/src/client/service.ts
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-model-selection/src/client/ModelSelect.module.css.mjs
		const css = ".qrlgDW_root{min-width:0;position:relative}.qrlgDW_trigger{min-width:0;max-width:220px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.qrlgDW_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.qrlgDW_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-state-business-primary)}.qrlgDW_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.qrlgDW_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.qrlgDW_triggerEffort{color:var(--dsw-alias-label-caption);flex:none}.qrlgDW_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.qrlgDW_chevronOpen{transform:rotate(180deg)}.qrlgDW_menu{z-index:20;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:min(240px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0;overflow:hidden}.qrlgDW_status,.qrlgDW_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.qrlgDW_error,.qrlgDW_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.qrlgDW_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}.qrlgDW_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.qrlgDW_groups{min-height:0;overflow-y:auto}.qrlgDW_group+.qrlgDW_group{margin-top:4px}.qrlgDW_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.qrlgDW_option{width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.qrlgDW_option:hover:not(:disabled),.qrlgDW_option:focus-visible{background:var(--dsw-alias-interactive-bg-active)}.qrlgDW_selected{background:0 0}.qrlgDW_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.qrlgDW_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.qrlgDW_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.qrlgDW_description{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.qrlgDW_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.qrlgDW_cell{width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.qrlgDW_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.qrlgDW_cellLabel{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}.qrlgDW_cellValue{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:0 auto;overflow:hidden}.qrlgDW_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		...
		var ModelSelect_module_css_default = {
			"triggerLabel": "qrlgDW_triggerLabel",
			"check": "qrlgDW_check",
			"trigger": "qrlgDW_trigger",
			"chevron": "qrlgDW_chevron",
			"warning": "qrlgDW_warning",
			"groupTitle": "qrlgDW_groupTitle",
			"selected": "qrlgDW_selected",
			"cellValue": "qrlgDW_cellValue",
			"cellChevron": "qrlgDW_cellChevron",
			"optionCopy": "qrlgDW_optionCopy",
			"menu": "qrlgDW_menu",
			"groups": "qrlgDW_groups",
			"retry": "qrlgDW_retry",
			"group": "qrlgDW_group",
			"modelName": "qrlgDW_modelName",
			"root": "qrlgDW_root",
			"cell": "qrlgDW_cell",
			"option": "qrlgDW_option",
			"cellLabel": "qrlgDW_cellLabel",
			"chevronOpen": "qrlgDW_chevronOpen",
			"error": "qrlgDW_error",
			"status": "qrlgDW_status",
			"description": "qrlgDW_description",
			"triggerEffort": "qrlgDW_triggerEffort",
			"empty": "qrlgDW_empty"
		};
		//#endregion
		//#region packages/client/ui-model-selection/src/client/ModelSelect.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-model-selection/src/client/locales.ts
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-model-selection/src/client/index.ts
