window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/kambiu/worker/open/deepseek-harness/packages/client/ui-skill/src/client/SkillRow.module.css.mjs
		const css = "._2CCPcq_card{flex-direction:column;display:flex}._2CCPcq_row{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}._2CCPcq_row[data-expandable]{cursor:pointer}._2CCPcq_card[data-state=running] ._2CCPcq_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite _2CCPcq_dsh-skill-row-sweep;position:absolute;inset:0 auto 0 0}@keyframes _2CCPcq_dsh-skill-row-sweep{0%{left:-300px}90%,to{left:100%}}._2CCPcq_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}._2CCPcq_chevron{color:var(--dsw-alias-label-secondary)}._2CCPcq_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}._2CCPcq_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}._2CCPcq_row:hover ._2CCPcq_iconIdle{opacity:0}._2CCPcq_row:hover ._2CCPcq_chevronHover{opacity:1}._2CCPcq_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}._2CCPcq_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}._2CCPcq_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}._2CCPcq_errorSummary{color:var(--dsw-alias-state-error-primary)}._2CCPcq_bodyWrap{flex-direction:column;display:flex}._2CCPcq_instructionsCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);border-radius:12px;flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:hidden}._2CCPcq_instructionsHeader{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block-banner);color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:8px 12px;font-size:11px;font-weight:500;line-height:16px}._2CCPcq_instructions{white-space:pre-wrap;overflow-wrap:anywhere;min-height:0;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);margin:0;padding:10px 12px 12px;overflow:auto}._2CCPcq_instructions[data-error]{color:var(--dsw-alias-state-error-primary)}._2CCPcq_instructions::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}._2CCPcq_instructions::-webkit-scrollbar-track{margin:6px 0}._2CCPcq_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}._2CCPcq_card:hover ._2CCPcq_inspectButton,._2CCPcq_inspectButton:focus-visible{opacity:1}._2CCPcq_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}._2CCPcq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){._2CCPcq_card[data-state=running] ._2CCPcq_row:after{animation:none;display:none}._2CCPcq_iconIdle,._2CCPcq_chevronHover,._2CCPcq_inspectButton{transition:none}}";
		...
		var SkillRow_module_css_default = {
			"instructionsHeader": "_2CCPcq_instructionsHeader",
			"leading": "_2CCPcq_leading",
			"dsh-skill-row-sweep": "_2CCPcq_dsh-skill-row-sweep",
			"separator": "_2CCPcq_separator",
			"visuallyHidden": "_2CCPcq_visuallyHidden",
			"summary": "_2CCPcq_summary",
			"chevron": "_2CCPcq_chevron",
			"chevronHover": "_2CCPcq_chevronHover",
			"row": "_2CCPcq_row",
			"card": "_2CCPcq_card",
			"title": "_2CCPcq_title",
			"iconIdle": "_2CCPcq_iconIdle",
			"inspectButton": "_2CCPcq_inspectButton",
			"errorSummary": "_2CCPcq_errorSummary",
			"instructions": "_2CCPcq_instructions",
			"bodyWrap": "_2CCPcq_bodyWrap",
			"instructionsCard": "_2CCPcq_instructionsCard"
		};
		//#endregion
