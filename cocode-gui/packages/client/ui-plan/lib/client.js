window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-plan/src/client/PlanModeControl.module.css.mjs
		const css = ".tOPoKa_wrap{align-items:center;gap:6px;display:inline-flex}.tOPoKa_chip{background:var(--dsw-alias-state-warn-tertiary);min-width:34px;color:var(--dsw-alias-state-warn-label);cursor:pointer;border:none;border-radius:999px;align-items:center;gap:4px;padding:2px 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.tOPoKa_chip:hover:not(:disabled){color:var(--dsw-alias-state-warn-primary)}.tOPoKa_chip:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.tOPoKa_chip:disabled{opacity:.6;cursor:default}.tOPoKa_close{color:currentColor;align-items:center;display:inline-flex}.tOPoKa_error{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}";
		...
		//#endregion
		//#region packages/client/ui-plan/src/client/PlanModeControl.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-plan/src/client/locales.ts
		...
		//#endregion
		//#region packages/client/ui-plan/src/client/index.ts
