...
import { FULL_ACCESS_PRESET, localizedPermissionPresetLabel } from './presentation.ts'
...
export function PermissionRow({ load, select, usePermission, t }: PermissionRowProps) {
  ...
  const label = selected
    ? localizedPermissionPresetLabel(t, selected.id, selected.label, 'preset.')
      ...
      <div className={css.row}>
        ...
        <Menu
          ...
          items={state.options.map(option => ({
            id: option.id,
            label: localizedPermissionPresetLabel(t, option.id, option.label, 'preset.'),
          }))}
