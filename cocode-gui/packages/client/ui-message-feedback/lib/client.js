window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/deepseek-harness/packages/client/ui-message-feedback/src/client/MessageFeedbackActions.module.css.mjs
		const css = ".X_D3oW_action{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.X_D3oW_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.X_D3oW_action:disabled{cursor:default;opacity:.4}.X_D3oW_action[data-active]{color:var(--dsw-alias-label-primary)}.X_D3oW_noteOpen{max-width:220px;color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:14px;padding:0 8px;font-size:13px;line-height:28px;overflow:hidden}.X_D3oW_noteOpen:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.X_D3oW_noteEditor{align-items:flex-start;gap:6px;display:inline-flex}.X_D3oW_noteInput{border:1px solid var(--dsw-alias-border-secondary);background:var(--dsw-alias-bg-primary);width:260px;color:var(--dsw-alias-label-primary);font:inherit;resize:vertical;border-radius:8px;padding:6px 8px;font-size:13px}.X_D3oW_noteSave,.X_D3oW_noteCancel{cursor:pointer;border:none;border-radius:14px;height:28px;padding:0 10px;font-size:13px}.X_D3oW_noteSave{background:var(--dsw-alias-interactive-bg-primary);color:var(--dsw-alias-label-inverse)}.X_D3oW_noteSave:disabled{cursor:default;opacity:.4}.X_D3oW_noteCancel{color:var(--dsw-alias-label-tertiary);background:0 0}.X_D3oW_noteCancel:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.X_D3oW_failure{color:var(--dsw-alias-label-tertiary);padding-left:4px;font-size:13px;line-height:28px}";
		...
		var MessageFeedbackActions_module_css_default = {
			"action": "X_D3oW_action",
			"noteOpen": "X_D3oW_noteOpen",
			"noteEditor": "X_D3oW_noteEditor",
			"noteInput": "X_D3oW_noteInput",
			"noteCancel": "X_D3oW_noteCancel",
			"failure": "X_D3oW_failure",
			"noteSave": "X_D3oW_noteSave"
		};
		//#endregion
