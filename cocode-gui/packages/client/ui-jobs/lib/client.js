window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-jobs/src/client/JobListAction.module.css.mjs
		const css = ".zD9BAq_root{position:relative}.zD9BAq_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.zD9BAq_trigger:hover,.zD9BAq_trigger:focus-visible{color:var(--dsw-alias-state-business-primary)}.zD9BAq_trigger svg{transition:transform .12s}.zD9BAq_triggerOpen{transform:rotate(180deg)}.zD9BAq_triggerDot{flex:none}.zD9BAq_count{margin:0 5px}.zD9BAq_menu{z-index:100;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(420px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;gap:1px;margin:0;padding:4px;list-style:none;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.zD9BAq_row{box-sizing:border-box;width:100%;min-height:32px;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;line-height:18px;display:flex}.zD9BAq_rowSettled{color:var(--dsw-alias-label-tertiary)}.zD9BAq_rowDot{flex:none}.zD9BAq_kind{background:var(--dsw-alias-fill-l2);color:var(--dsw-alias-label-secondary);border-radius:5px;flex:none;padding:0 6px;font-size:11px;line-height:18px}.zD9BAq_label{min-width:0;font-family:var(--dsw-font-mono);white-space:nowrap;text-overflow:ellipsis;flex:1;overflow:hidden}.zD9BAq_status,.zD9BAq_duration{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px;line-height:18px}.zD9BAq_status{white-space:nowrap;text-overflow:ellipsis;max-width:40%;overflow:hidden}.zD9BAq_duration{font-variant-numeric:tabular-nums}";
		...
		var JobListAction_module_css_default = {
			"triggerOpen": "zD9BAq_triggerOpen",
			"rowDot": "zD9BAq_rowDot",
			"trigger": "zD9BAq_trigger",
			"root": "zD9BAq_root",
			"kind": "zD9BAq_kind",
			"label": "zD9BAq_label",
			"status": "zD9BAq_status",
			"triggerDot": "zD9BAq_triggerDot",
			"duration": "zD9BAq_duration",
			"count": "zD9BAq_count",
			"row": "zD9BAq_row",
			"menu": "zD9BAq_menu",
			"rowSettled": "zD9BAq_rowSettled"
		};
		//#endregion
		//#region packages/client/ui-jobs/src/client/JobListAction.tsx
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-jobs/src/client/locales.ts
		...
		//#endregion
		//#region packages/client/ui-jobs/src/client/index.ts
