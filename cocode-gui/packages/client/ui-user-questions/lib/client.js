window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region packages/client/ui-user-questions/src/client/contract/slots.ts
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-user-questions/src/client/PlanReviewPanel.module.css.mjs
		const css$1 = ".jzlR-a_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.jzlR-a_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;display:flex;overflow:hidden}.jzlR-a_card,.jzlR-a_card *{box-sizing:border-box}.jzlR-a_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);flex-shrink:0;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}.jzlR-a_dot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}.jzlR-a_body{overscroll-behavior:contain;flex:auto;min-height:0;padding:12px 16px 4px;font-size:14px;line-height:22px;overflow-y:auto}.jzlR-a_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;padding:8px 16px 12px;display:flex}.jzlR-a_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:16px}.jzlR-a_actions{flex-shrink:0;align-items:center;gap:8px;display:flex}.jzlR-a_discuss{color:var(--dsw-alias-label-secondary);gap:6px}.jzlR-a_discuss:hover:not(:disabled){color:var(--dsw-alias-label-primary)}@media (width<=720px){.jzlR-a_card{border-radius:16px}.jzlR-a_body{padding:10px 12px 4px}.jzlR-a_footer{align-items:flex-end;padding:8px 12px 10px}}";
		...
		var PlanReviewPanel_module_css_default = {
			...
			"dot": "jzlR-a_dot",
			"strip": "jzlR-a_strip",
			"discuss": "jzlR-a_discuss",
			"footer": "jzlR-a_footer",
			"frame": "jzlR-a_frame",
			"actions": "jzlR-a_actions",
			"feedback": "jzlR-a_feedback",
			"body": "jzlR-a_body"
		};
		//#endregion
		//#region packages/client/ui-user-questions/src/client/PlanReviewPanel.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-user-questions/src/client/QuestionComposer.module.css.mjs
		const css = ".o9hsEW_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.o9hsEW_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;padding:0 0 10px;display:flex;overflow:hidden}.o9hsEW_card,.o9hsEW_card *{box-sizing:border-box}.o9hsEW_header{flex-shrink:0;justify-content:space-between;align-items:flex-start;gap:16px;padding:20px 16px 0 24px;display:flex}.o9hsEW_headingBlock{min-width:0}.o9hsEW_eyebrow{color:var(--dsw-alias-label-tertiary);margin-bottom:5px;font-size:11px;line-height:16px}.o9hsEW_title{margin:0;font-size:16px;font-weight:500;line-height:22px}.o9hsEW_detail{margin:0 2px 8px}.o9hsEW_footerActions{flex-shrink:0;align-items:center;gap:12px;display:flex}.o9hsEW_pager{flex-shrink:0;align-items:center;gap:6px;display:flex}.o9hsEW_progress{color:var(--dsw-alias-label-secondary);white-space:nowrap;word-spacing:-2px;padding:0 4px;font-size:14px;font-weight:500;line-height:24px}.o9hsEW_iconButton{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;place-items:center;padding:0;display:grid}.o9hsEW_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.o9hsEW_iconButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.o9hsEW_body{overscroll-behavior:contain;flex-direction:column;flex:auto;min-height:0;display:flex;overflow-y:auto}.o9hsEW_options{flex-direction:column;gap:1px;margin:8px 0 0;padding:4px 12px;display:flex}.o9hsEW_option{width:100%;min-height:40px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.o9hsEW_option:hover:not(:disabled),.o9hsEW_optionSelected{background:var(--dsw-alias-interactive-bg-hover)}.o9hsEW_optionSelected{border-color:var(--dsw-alias-border-l2)}.o9hsEW_option:disabled{cursor:default}.o9hsEW_number{background:var(--dsw-alias-bg-overlay);width:20px;height:20px;color:var(--dsw-alias-label-secondary);border-radius:6px;flex:0 0 20px;place-items:center;margin-top:2px;font-size:12px;font-weight:500;line-height:18px;display:grid}.o9hsEW_checkbox{flex:0 0 20px;place-items:center;width:20px;height:20px;margin-top:2px;display:grid}.o9hsEW_checkbox:before{content:\"\";border:1px solid var(--dsw-alias-border-l4);border-radius:4px;grid-area:1/1;width:14px;height:14px;transition:background-color .12s,border-color .12s}.o9hsEW_checkbox>svg{grid-area:1/1}.o9hsEW_checkboxChecked{color:var(--dsw-alias-label-primary-foreground)}.o9hsEW_checkboxChecked:before{border-color:var(--dsw-alias-label-primary);background:var(--dsw-alias-label-primary)}.o9hsEW_optionCopy{flex:1;min-width:0}.o9hsEW_optionLine{flex-wrap:wrap;align-items:baseline;gap:2px 6px;display:flex}.o9hsEW_optionLabel{font-size:14px;font-weight:500;line-height:24px}.o9hsEW_badge{background:var(--dsw-specific-sidebar-nav-item-active-accent);color:var(--dsw-alias-button-info-fill);border-radius:6px;padding:0 4px;font-size:11px;font-weight:600;line-height:18px}.o9hsEW_description{color:var(--dsw-alias-label-tertiary);font-size:14px;font-weight:400;line-height:24px}.o9hsEW_customRow{border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;width:100%;min-height:40px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.o9hsEW_customRow:hover,.o9hsEW_customRow:focus-within,.o9hsEW_customRowActive{background:var(--dsw-alias-interactive-bg-hover)}.o9hsEW_customRow:focus-within,.o9hsEW_customRowActive{border-color:var(--dsw-alias-state-business-primary)}.o9hsEW_customInput{min-width:0;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;background:0 0;border:none;outline:none;flex:1;padding:0;font-size:14px;line-height:24px}.o9hsEW_customInput::placeholder{color:var(--dsw-alias-label-caption)}.o9hsEW_customTextarea{resize:none;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);min-height:64px;max-height:140px;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;border-radius:10px;outline:none;flex-shrink:0;margin:0 12px;padding:8px 12px;font-size:14px;line-height:24px;display:block}.o9hsEW_customTextarea:focus{border-color:var(--dsw-alias-state-business-primary)}.o9hsEW_customTextarea::placeholder{color:var(--dsw-alias-label-caption)}.o9hsEW_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding:0 10px 0 18px;display:flex}.o9hsEW_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);text-align:right;flex:1;font-size:11px;line-height:16px}@media (width<=720px){.o9hsEW_card{border-radius:16px}.o9hsEW_header{padding:10px 12px 0 18px}.o9hsEW_options{padding:4px 8px}.o9hsEW_title{font-size:15px;line-height:21px}.o9hsEW_option,.o9hsEW_customRow{padding:8px 6px}.o9hsEW_footer{align-items:flex-end;padding:0 10px}.o9hsEW_footerActions{flex-shrink:0}}@media (prefers-reduced-motion:reduce){.o9hsEW_option,.o9hsEW_customRow{transition:none}}";
		...
		var QuestionComposer_module_css_default = {
			"body": "o9hsEW_body",
			"description": "o9hsEW_description",
			"card": "o9hsEW_card",
			"badge": "o9hsEW_badge",
			"headingBlock": "o9hsEW_headingBlock",
			"optionLabel": "o9hsEW_optionLabel",
			"customTextarea": "o9hsEW_customTextarea",
			"options": "o9hsEW_options",
			"iconButton": "o9hsEW_iconButton",
			"header": "o9hsEW_header",
			"customInput": "o9hsEW_customInput",
			"customRowActive": "o9hsEW_customRowActive",
			"optionLine": "o9hsEW_optionLine",
			"checkboxChecked": "o9hsEW_checkboxChecked",
			"feedback": "o9hsEW_feedback",
			"option": "o9hsEW_option",
			"pager": "o9hsEW_pager",
			"checkbox": "o9hsEW_checkbox",
			"eyebrow": "o9hsEW_eyebrow",
			"progress": "o9hsEW_progress",
			"optionSelected": "o9hsEW_optionSelected",
			"footer": "o9hsEW_footer",
			"title": "o9hsEW_title",
			"customRow": "o9hsEW_customRow",
			"optionCopy": "o9hsEW_optionCopy",
			"detail": "o9hsEW_detail",
			"footerActions": "o9hsEW_footerActions",
			"frame": "o9hsEW_frame",
			"number": "o9hsEW_number"
		};
		//#endregion
		//#region packages/client/ui-user-questions/src/client/QuestionComposer.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-user-questions/src/client/locales.ts
		...
		//#endregion
		//#region packages/client/ui-user-questions/src/client/index.ts
