window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-directory-picker-browse/src/client/DirectoryBrowser.module.css.mjs
		const css = ".xYveLq_dialog.xYveLq_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}.xYveLq_editorScope{display:contents}.xYveLq_header{border-bottom:1px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}.xYveLq_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}.xYveLq_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}.xYveLq_crumbBar:has(.xYveLq_crumbEditZone:enabled:hover),.xYveLq_crumbBar:has(.xYveLq_crumbEditZone:focus-visible),.xYveLq_crumbBar:has(.xYveLq_pathInput){border-color:var(--dsw-alias-state-business-primary)}.xYveLq_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}.xYveLq_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}.xYveLq_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}.xYveLq_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.xYveLq_crumb:hover{color:var(--dsw-alias-state-business-primary)}.xYveLq_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}.xYveLq_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}.xYveLq_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}.xYveLq_crumbEditZone:enabled:hover .xYveLq_crumbEditGlyph,.xYveLq_crumbEditZone:focus-visible .xYveLq_crumbEditGlyph{color:var(--dsw-alias-state-business-primary)}.xYveLq_crumbEditZone:disabled{cursor:default}.xYveLq_crumbEditZone:disabled .xYveLq_crumbEditGlyph{color:var(--dsw-alias-label-caption)}.xYveLq_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}.xYveLq_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}.xYveLq_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}.xYveLq_divider{background:var(--dsw-alias-border-l3);flex:none;width:1px}.xYveLq_rowSeat{flex:none;display:flex}.xYveLq_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}.xYveLq_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.xYveLq_rowSelected,.xYveLq_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}.xYveLq_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}.xYveLq_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}.xYveLq_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.xYveLq_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}.xYveLq_status,.xYveLq_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}.xYveLq_status{color:var(--dsw-alias-label-secondary)}.xYveLq_error{color:var(--dsw-alias-state-error-primary)}.xYveLq_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}.xYveLq_footerBar{border-top:1px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}.xYveLq_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.xYveLq_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}.xYveLq_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}.xYveLq_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}.xYveLq_footerGap{flex:1 1 0}.xYveLq_footerAction{min-width:72px}.xYveLq_createDialog.xYveLq_createDialog{gap:0;width:min(380px,100%);padding:0}.xYveLq_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}.xYveLq_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}.xYveLq_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}.xYveLq_createInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}.xYveLq_createInput::placeholder{color:var(--dsw-alias-label-caption)}.xYveLq_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		...
		var DirectoryBrowser_module_css_default = {
			"createIn": "xYveLq_createIn",
			"createBody": "xYveLq_createBody",
			"pathInput": "xYveLq_pathInput",
			"rowName": "xYveLq_rowName",
			"showHiddenToggleActive": "xYveLq_showHiddenToggleActive",
			"crumb": "xYveLq_crumb",
			"column": "xYveLq_column",
			"crumbEditZone": "xYveLq_crumbEditZone",
			"content": "xYveLq_content",
			"loadingFloat": "xYveLq_loadingFloat",
			"title": "xYveLq_title",
			"crumbEditGlyph": "xYveLq_crumbEditGlyph",
			"footerBar": "xYveLq_footerBar",
			"footerGap": "xYveLq_footerGap",
			"createDialog": "xYveLq_createDialog",
			"createInput": "xYveLq_createInput",
			"crumbBar": "xYveLq_crumbBar",
			"rowIcon": "xYveLq_rowIcon",
			"rowSelected": "xYveLq_rowSelected",
			"createTitle": "xYveLq_createTitle",
			"status": "xYveLq_status",
			"header": "xYveLq_header",
			"dialog": "xYveLq_dialog",
			"millerRow": "xYveLq_millerRow",
			"rowChevron": "xYveLq_rowChevron",
			"crumbChevron": "xYveLq_crumbChevron",
			"crumbSeat": "xYveLq_crumbSeat",
			"divider": "xYveLq_divider",
			"editorScope": "xYveLq_editorScope",
			"crumbTrail": "xYveLq_crumbTrail",
			"rowIconSelected": "xYveLq_rowIconSelected",
			"showHiddenToggle": "xYveLq_showHiddenToggle",
			"row": "xYveLq_row",
			"footerAction": "xYveLq_footerAction",
			"rowSeat": "xYveLq_rowSeat",
			"error": "xYveLq_error",
			"createActions": "xYveLq_createActions"
		};
		//#endregion
		//#region packages/client/ui-directory-picker-browse/src/client/DirectoryBrowser.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-directory-picker-browse/src/client/flow.ts
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-directory-picker-browse/src/client/index.ts
