window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region packages/client/ui-trajectory/src/client/duration-store.ts
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-trajectory/src/client/locales.ts
		...
		//#endregion
		//#region packages/client/ui-trajectory/src/client/trajectory-definition-common.ts
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-trajectory/src/client/trajectory-assistant-definition.ts
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-trajectory/src/client/trajectory-compaction-definition.ts
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-trajectory/src/client/trajectory-message-definitions.ts
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-trajectory/src/client/trajectory-request-header-definition.ts
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-trajectory/src/client/trajectory-snapshot-builder.ts
		const EMPTY_LIST = [];
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-trajectory/src/client/trajectory-tool-definition.ts
		const MAX_DEPTH = 256;
		...
		*/
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/@tanstack+virtual-core@3.17.7/node_modules/@tanstack/virtual-core/dist/cjs/lazy-measurements.cjs
		var require_lazy_measurements = /* @__PURE__ */ __commonJSMin(((exports) => {
			Object.defineProperty(exports, Symbol.toStringTag, { value: "Module" });
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/@tanstack+virtual-core@3.17.7/node_modules/@tanstack/virtual-core/dist/cjs/utils.cjs
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/@tanstack+virtual-core@3.17.7/node_modules/@tanstack/virtual-core/dist/cjs/index.cjs
		var require_cjs$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
			Object.defineProperty(exports, Symbol.toStringTag, { value: "Module" });
			const lazyMeasurements = require_lazy_measurements();
			...
			const observeOffset = (instance, cb, readOffset) => {
				...
				let offset = 0;
				const fallback = registerScrollendEvent ? null : utils.debounce(targetWindow, () => cb(offset, false), instance.options.isScrollingResetDelay);
			...
			var Virtualizer = class {
				constructor(opts) {
					...
					this.getMeasurements = utils.memo(() => [this.getMeasurementOptions(), this.itemSizeCacheVersion], ({ count, paddingStart, scrollMargin, getItemKey, enabled, lanes, laneAssignmentMode, gap }, _itemSizeCacheVersion) => {
					...
					this.getVirtualItems = utils.memo(() => [this.getVirtualIndexes(), this.getMeasurements()], (indexes, measurements) => {
						const virtualItems = [];
					...
					this.getVirtualItemForOffset = (offset) => {
						...
						const idx = findNearestBinarySearch(0, measurements.length - 1, useFlat ? (i) => flat[i * 2] : (i) => utils.notUndefined(measurements[i]).start, offset);
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/@tanstack+react-virtual@3.14.9_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@tanstack/react-virtual/dist/cjs/index.cjs
		var require_cjs = /* @__PURE__ */ __commonJSMin(((exports) => {
			Object.defineProperty(exports, Symbol.toStringTag, { value: "Module" });
			const React = require("react");
			const reactDom = require("react-dom");
			const virtualCore = require_cjs$1();
			...
			function useVirtualizerBase({ useFlushSync = true, directDomUpdates = false, directDomUpdatesMode = "transform", ...options }) {
				...
				const resolvedOptions = {
					...
					onChange: (instance2, sync) => {
						...
						if (shouldRerender) if (useFlushSync && sync) reactDom.flushSync(rerender);
						else rerender();
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/diff/base.js
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/diff/character.js
		var require_character = /* @__PURE__ */ __commonJSMin(((exports) => {
			...
			const base_js_1 = __importDefault(require_base());
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/util/string.js
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/diff/word.js
		var require_word = /* @__PURE__ */ __commonJSMin(((exports) => {
			...
			const base_js_1 = __importDefault(require_base());
			const string_js_1 = require_string();
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/util/params.js
 ...
 /* istanbul ignore else */
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/diff/line.js
		var require_line = /* @__PURE__ */ __commonJSMin(((exports) => {
			...
			const base_js_1 = __importDefault(require_base());
			const params_js_1 = require_params();
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/diff/sentence.js
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/diff/css.js
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/diff/json.js
 ...
 /* istanbul ignore else */
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/diff/array.js
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/patch/line-endings.js
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/patch/parse.js
			...
			function parsePatch(uniDiff) {
				...
				function parseIndex() {
					...
					while (i < diffstr.length) {
						...
						if (isFileHeader(line) || isHunkHeader(line)) break;
						if (isGitDiffHeader(line)) {
							if (seenDiffHeader) return;
							seenDiffHeader = true;
							index.isGit = true;
							...
							while (i < diffstr.length) {
								...
								if (isFileHeader(extLine) || isHunkHeader(extLine) || isDiffHeader(extLine)) break;
								...
								if (oldModeMatch) index.oldMode = oldModeMatch[1];
								const newModeMatch = /^new mode (\d+)/.exec(extLine);
								if (newModeMatch) index.newMode = newModeMatch[1];
								if (/^Binary files /.test(extLine)) index.isBinary = true;
								i++;
							}
							continue;
					...
					parseFileHeader(index);
					if (index.oldFileName === void 0 !== (index.newFileName === void 0)) throw new Error("Missing " + (index.oldFileName !== void 0 ? "\"+++ ...\"" : "\"--- ...\"") + " file header for " + ((_a = index.oldFileName) !== null && _a !== void 0 ? _a : index.newFileName));
					while (i < diffstr.length) {
						const line = diffstr[i];
						if (isDiffHeader(line) || isFileHeader(line) || /^===================================================================/.test(line)) break;
						else if (isHunkHeader(line)) index.hunks.push(parseHunk());
						else i++;
					}
				}
				/**
				...
				*/
					...
					while (j < s.length) {
						...
						if (s[j] === "\\" && j + 1 < s.length) {
							...
							switch (s[j]) {
								...
								case "6":
								case "7": {
									if (j + 2 >= s.length || s[j + 1] < "0" || s[j + 1] > "7" || s[j + 2] < "0" || s[j + 2] > "7") return null;
									const bytes = [parseInt(s.substring(j, j + 3), 8)];
									j += 3;
									while (s[j] === "\\" && s[j + 1] >= "0" && s[j + 1] <= "7") {
										if (j + 3 >= s.length || s[j + 2] < "0" || s[j + 2] > "7" || s[j + 3] < "0" || s[j + 3] > "7") return null;
				...
				function parseFileHeader(index) {
					...
					if (fileHeaderMatch) {
						...
						let fileName = data[0];
						if (fileName.startsWith("\"")) fileName = unquoteIfQuoted(fileName);
				...
				function parseHunk() {
					var _a;
					const chunkHeaderIndex = i, chunkHeader = diffstr[i++].split(/@@ -(\d+)(?:,(\d+))? \+(\d+)(?:,(\d+))? @@/);
					const hunk = {
					...
					for (; i < diffstr.length && (removeCount < hunk.oldLines || addCount < hunk.newLines || ((_a = diffstr[i]) === null || _a === void 0 ? void 0 : _a.startsWith("\\"))); i++) {
						...
						} else throw new Error(`Hunk at line ${chunkHeaderIndex + 1} contained invalid line ${diffstr[i]}`);
					}
					...
					if (i < diffstr.length && diffstr[i] && /^[+ -]/.test(diffstr[i]) && !isFileHeader(diffstr[i])) throw new Error("Hunk at line " + (chunkHeaderIndex + 1) + " has more lines than expected (expected " + hunk.oldLines + " old lines and " + hunk.newLines + " new lines)");
					return hunk;
				}
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/util/distance-iterator.js
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/patch/apply.js
		var require_apply = /* @__PURE__ */ __commonJSMin(((exports) => {
			...
			const string_js_1 = require_string();
			const line_endings_js_1 = require_line_endings();
			const parse_js_1 = require_parse();
			const distance_iterator_js_1 = __importDefault(require_distance_iterator());
			/**
			...
			function applyStructuredPatch(source, patch, options = {}) {
				...
				*/
				...
				for (let i = 0; i < hunks.length; i++) {
					...
					for (let i = minLine; i < toPos; i++) resultLines.push(lines[i]);
				...
				for (let i = minLine; i < lines.length; i++) resultLines.push(lines[i]);
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/patch/reverse.js
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/patch/create.js
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/convert/dmp.js
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/convert/xml.js
		...
		//#endregion
		//#region ../deepseek-harness/node_modules/.pnpm/diff@9.0.0/node_modules/diff/libcjs/index.js
		var require_libcjs = /* @__PURE__ */ __commonJSMin(((exports) => {
			...
			exports.Diff = __importDefault(require_base()).default;
			const character_js_1 = require_character();
			...
			const sentence_js_1 = require_sentence();
			...
			const array_js_1 = require_array();
			...
			const apply_js_1 = require_apply();
			...
			const reverse_js_1 = require_reverse();
			...
			const create_js_1 = require_create();
		...
		//#endregion
		//#region packages/client/ui-trajectory/src/client/trajectory-record.ts
		var import_cjs = require_cjs();
		var import_libcjs = require_libcjs();
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-trajectory/src/client/trajectory-virtual-rows.ts
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-trajectory/src/client/trajectory-preview.ts
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-trajectory/src/client/TrajectoryTable.module.css.mjs
		const css$3 = ".NK7xpG_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}.NK7xpG_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:NK7xpG_trajectory-table/inline-size}.NK7xpG_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}.NK7xpG_historyLoadingBar{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}.NK7xpG_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;width:10px;height:10px;animation:.7s linear infinite NK7xpG_history-loading-spin}.NK7xpG_table tbody .NK7xpG_historyLoadRow td{height:30px;padding:0}.NK7xpG_table tbody .NK7xpG_historyLoadRow+tr[data-turn-start=true] td:before{content:none}.NK7xpG_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}.NK7xpG_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.NK7xpG_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.NK7xpG_historyLoadButton:disabled{cursor:default}.NK7xpG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.NK7xpG_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes NK7xpG_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.NK7xpG_historyLoadingSpinner{animation:none}}.NK7xpG_table{--trajectory-turn-accent:color-mix(in srgb, var(--cocode-accent) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}.NK7xpG_eventColumn{width:122px}.NK7xpG_contentColumn{width:auto}.NK7xpG_table th{z-index:3;box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}.NK7xpG_eventHeader{text-align:right!important;padding-right:4px!important}.NK7xpG_table td{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}.NK7xpG_table tbody .NK7xpG_virtualSpacer{pointer-events:none}.NK7xpG_table tbody .NK7xpG_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}.NK7xpG_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}.NK7xpG_table tbody tr[data-timeline-focus=outside]{opacity:.24}.NK7xpG_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}.NK7xpG_table tbody tr[data-request-only=true]:hover{background:0 0}.NK7xpG_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}.NK7xpG_table tbody tr[data-terminal-request-boundary=true] td{height:9px}.NK7xpG_table tbody tr[data-request-only=true] .NK7xpG_turnRail{top:-15px;bottom:0}.NK7xpG_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.NK7xpG_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.NK7xpG_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}.NK7xpG_requestBoundaryControl:before{background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}.NK7xpG_requestBoundaryControl:after{border:1px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);box-shadow:var(--ds-shadow-sm);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px)}.NK7xpG_requestBoundaryControl:hover:before,.NK7xpG_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.NK7xpG_requestBoundaryControlActive:before,.NK7xpG_requestBoundaryControlActive:hover:before,.NK7xpG_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.NK7xpG_requestBoundaryControl[data-request-status=error]:before,.NK7xpG_requestBoundaryControl[data-request-status=error]:hover:before,.NK7xpG_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}.NK7xpG_requestBoundaryControl:hover:after,.NK7xpG_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}.NK7xpG_requestBoundaryControl:focus-visible{outline:none}.NK7xpG_table tbody tr:has(.NK7xpG_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}.NK7xpG_event{position:relative}.NK7xpG_turnRail,.NK7xpG_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}.NK7xpG_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}.NK7xpG_table tbody tr[data-turn-end=true] .NK7xpG_turnRail{bottom:0}.NK7xpG_selectionRail{z-index:5;width:3px;top:0;bottom:0}.NK7xpG_table tbody tr[data-error=true] .NK7xpG_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}.NK7xpG_table tbody tr[data-error=true] .NK7xpG_selectionRail{background:var(--dsw-alias-state-error-primary)}.NK7xpG_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}.NK7xpG_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}.NK7xpG_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}.NK7xpG_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}.NK7xpG_turnLabelFull,.NK7xpG_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}.NK7xpG_turnLabelCompact{opacity:0;max-width:0}.NK7xpG_turnLabelActive{color:color-mix(in srgb, var(--cocode-accent-ink) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}.NK7xpG_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}.NK7xpG_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}.NK7xpG_kindSlot [role=tooltip]{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary)}.NK7xpG_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}.NK7xpG_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}.NK7xpG_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}.NK7xpG_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}.NK7xpG_table .NK7xpG_kindSlot .NK7xpG_message{justify-content:center;width:100%}@container NK7xpG_trajectory-table (width<=620px){.NK7xpG_eventColumn{width:50px}.NK7xpG_event{padding-left:28px!important;padding-right:3px!important}.NK7xpG_requestBoundaryControl{--request-boundary-base-left:6px}.NK7xpG_kindSlot{width:19px}.NK7xpG_kindTag,.NK7xpG_table .NK7xpG_kindSlot .NK7xpG_message{justify-content:center;width:19px;padding-left:0;padding-right:0}.NK7xpG_kindTagIcon{opacity:1;width:13px;transform:scale(1)}.NK7xpG_kindTagLabel,.NK7xpG_turnLabelFull{opacity:0;max-width:0}.NK7xpG_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){.NK7xpG_eventColumn,.NK7xpG_event,.NK7xpG_requestBoundaryControl,.NK7xpG_kindSlot,.NK7xpG_kindTag,.NK7xpG_kindTagIcon,.NK7xpG_kindTagLabel,.NK7xpG_turnLabelFull,.NK7xpG_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}.NK7xpG_eventColumn,.NK7xpG_kindSlot{transition-property:width}.NK7xpG_event{transition-property:padding-right,padding-left}.NK7xpG_requestBoundaryControl{transition-property:left}.NK7xpG_kindTag{transition-property:padding-right,padding-left}.NK7xpG_kindTagIcon{transition-property:width,opacity,transform}.NK7xpG_kindTagLabel,.NK7xpG_turnLabelFull,.NK7xpG_turnLabelCompact{transition-property:max-width,opacity}}.NK7xpG_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}.NK7xpG_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.NK7xpG_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}.NK7xpG_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.NK7xpG_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}.NK7xpG_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}.NK7xpG_promptDiffSection{min-width:0}.NK7xpG_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}.NK7xpG_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}.NK7xpG_promptDiff span{min-width:max-content;padding:0 6px;display:block}.NK7xpG_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}.NK7xpG_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}.NK7xpG_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}.NK7xpG_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}.NK7xpG_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}.NK7xpG_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}.NK7xpG_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}.NK7xpG_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.NK7xpG_toolCallOnly{color:var(--dsw-alias-label-tertiary)}.NK7xpG_table tbody tr[data-collapsed-summary=turn] td,.NK7xpG_table tbody tr[data-collapsed-summary=assistant] td{height:20px}.NK7xpG_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}.NK7xpG_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}.NK7xpG_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.NK7xpG_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}.NK7xpG_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}.NK7xpG_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.NK7xpG_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}.NK7xpG_resultRequest,.NK7xpG_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.NK7xpG_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}.NK7xpG_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}.NK7xpG_table tbody tr[data-kind=tool] .NK7xpG_contentText,.NK7xpG_table tbody tr[data-kind=subtool] .NK7xpG_contentText,.NK7xpG_table tbody tr[data-kind=tool] .NK7xpG_resultPreview,.NK7xpG_table tbody tr[data-kind=subtool] .NK7xpG_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}.NK7xpG_table tbody tr[data-kind=subtool] .NK7xpG_content{padding-left:26px}.NK7xpG_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}.NK7xpG_noOutputText{color:var(--dsw-alias-label-caption)}.NK7xpG_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}.NK7xpG_error,.NK7xpG_overview dd.NK7xpG_error,.NK7xpG_details .NK7xpG_errorPayload{color:var(--dsw-alias-state-error-primary)}.NK7xpG_details .NK7xpG_errorPayload .NK7xpG_resultBlockText{color:inherit}.NK7xpG_details .NK7xpG_jsonPayload.NK7xpG_errorPayload,.NK7xpG_details .NK7xpG_jsonPreview.NK7xpG_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}.NK7xpG_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}.NK7xpG_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}.NK7xpG_detailsResizeHandle:focus-visible{outline:none}.NK7xpG_detailsHeader{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}.NK7xpG_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.NK7xpG_requestDetailsDot{background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}.NK7xpG_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}.NK7xpG_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.NK7xpG_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}.NK7xpG_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.NK7xpG_detailTabs{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}.NK7xpG_detailTabs::-webkit-scrollbar{display:none}.NK7xpG_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}.NK7xpG_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.NK7xpG_detailTabActive{color:var(--dsw-alias-state-business-primary)}.NK7xpG_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}.NK7xpG_close:focus-visible,.NK7xpG_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.NK7xpG_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}.NK7xpG_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}.NK7xpG_detailBodySummary>.NK7xpG_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}.NK7xpG_detailBodySummary>.NK7xpG_compactedSummary{flex:1;min-height:0;overflow:auto}.NK7xpG_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.NK7xpG_summaryScrollRegion:hover,.NK7xpG_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}.NK7xpG_compactedSummary .NK7xpG_markdownPayload{padding-right:18px}.NK7xpG_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}.NK7xpG_overviewParentLinks{gap:14px;display:flex}.NK7xpG_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}.NK7xpG_overviewHierarchyNavLink:hover{color:var(--dsw-alias-state-business-primary)}.NK7xpG_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}.NK7xpG_overviewHierarchyNavLink:hover .NK7xpG_overviewHierarchyJumpIconTight,.NK7xpG_overviewHierarchyNavLink:focus-visible .NK7xpG_overviewHierarchyJumpIconTight{color:var(--dsw-alias-state-business-primary)}.NK7xpG_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-state-business-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.NK7xpG_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}.NK7xpG_overview>.NK7xpG_requestTokenDetail dt{padding-left:12px}.NK7xpG_usagePanel{padding:4px 0 10px}.NK7xpG_usageGroup+.NK7xpG_usageGroup{margin-top:8px}.NK7xpG_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}.NK7xpG_usageGroup .NK7xpG_overview{padding:0}.NK7xpG_overview dt{color:var(--dsw-alias-label-tertiary)}.NK7xpG_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.NK7xpG_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}.NK7xpG_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.NK7xpG_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}.NK7xpG_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}.NK7xpG_overviewSection+.NK7xpG_overviewSection{padding-top:8px}.NK7xpG_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}.NK7xpG_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}.NK7xpG_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}.NK7xpG_overviewTitle:hover .NK7xpG_overviewTitleIcon{color:var(--dsw-alias-label-primary)}.NK7xpG_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.NK7xpG_overviewTitle:focus-visible .NK7xpG_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}.NK7xpG_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}.NK7xpG_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}.NK7xpG_overviewPreview .NK7xpG_jsonPreview>:first-child,.NK7xpG_overviewPreview .NK7xpG_schemaTree>:first-child{padding-bottom:0}.NK7xpG_overviewPreview .NK7xpG_schemaTree{margin-bottom:0}.NK7xpG_overviewPreview .NK7xpG_overview{padding:2px 0 0}.NK7xpG_overviewPreview .NK7xpG_overview>div{min-height:22px}.NK7xpG_markdownPreview,.NK7xpG_markdownPayload{color:var(--dsw-alias-label-primary)}.NK7xpG_markdownPreview>div,.NK7xpG_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}.NK7xpG_markdownPreview>div h1,.NK7xpG_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}.NK7xpG_markdownPreview>div h2,.NK7xpG_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}.NK7xpG_markdownPreview>div :where(h3,h4,h5,h6),.NK7xpG_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}.NK7xpG_markdownPreview>div :not(pre)>code,.NK7xpG_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}.NK7xpG_markdownPreview>div table,.NK7xpG_markdownPayload>div table{font:var(--dsw-font-xs-13)}.NK7xpG_markdownPreview>div>:first-child{margin-top:0}.NK7xpG_markdownPreview>div>:last-child{margin-bottom:0}.NK7xpG_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}.NK7xpG_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}.NK7xpG_markdownPreview>div :where(p,ul,ol){margin:8px 0}.NK7xpG_markdownPreview>div li:not(:first-child){margin-top:3px}.NK7xpG_markdownPreview>div blockquote{margin-top:8px}.NK7xpG_markdownPreview>div hr{margin:14px 0}.NK7xpG_markdownPreview>div>.md-code-block{margin:10px 0}.NK7xpG_assistantContent .NK7xpG_markdownPayload,.NK7xpG_assistantContent .NK7xpG_payload{min-height:0}.NK7xpG_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}.NK7xpG_thinkingQuoteOnlyPreview{margin-bottom:8px}.NK7xpG_detailBody>.NK7xpG_assistantContentRendered .NK7xpG_thinkingQuote{margin-top:14px}.NK7xpG_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}.NK7xpG_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}.NK7xpG_thinkingToggle[aria-expanded=true] .NK7xpG_thinkingChevron{transform:rotate(90deg)}.NK7xpG_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}.NK7xpG_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.NK7xpG_thinkingQuote .NK7xpG_markdownPreview,.NK7xpG_thinkingQuote .NK7xpG_markdownPayload,.NK7xpG_thinkingQuote .NK7xpG_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}.NK7xpG_assistantOutput{background:var(--dsw-alias-bg-layer-1)}.NK7xpG_markdownPreview{padding:6px 14px 8px}.NK7xpG_markdownPayload{min-height:100%;padding:14px}.NK7xpG_jsonPayload{min-height:100%}.NK7xpG_jsonPreview{min-height:0}.NK7xpG_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}.NK7xpG_schemaPreview{min-height:0}.NK7xpG_schemaIntro{padding:12px 14px 6px}.NK7xpG_schemaPreview .NK7xpG_schemaIntro{padding-top:6px}.NK7xpG_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}.NK7xpG_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}.NK7xpG_schemaParameters{min-width:0}.NK7xpG_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}.NK7xpG_schemaTree{margin:0 6px 8px 0}.NK7xpG_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}.NK7xpG_payloadPreview{min-height:0;padding:6px 14px 8px}.NK7xpG_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}.NK7xpG_sourceBlock+.NK7xpG_sourceBlock{margin-top:14px}.NK7xpG_sourceBlockHeader,.NK7xpG_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.NK7xpG_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.NK7xpG_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}.NK7xpG_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}.NK7xpG_sourceBlockJumpTarget:hover .NK7xpG_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}.NK7xpG_sourceBlockJumpTarget:focus-visible{outline:none}.NK7xpG_sourceBlockJumpTarget:focus-visible .NK7xpG_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}.NK7xpG_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.NK7xpG_panelImageLink{cursor:zoom-in;border-radius:4px;width:auto;max-width:100%;display:block;overflow:hidden}.NK7xpG_panelImageLinkPreview{max-height:140px}.NK7xpG_panelImage{border-radius:inherit;background:var(--dsw-alias-bg-base);object-fit:contain;width:auto;max-width:100%;height:auto;max-height:320px;margin:0;display:block}.NK7xpG_panelImageLinkPreview .NK7xpG_panelImage{max-height:140px}.NK7xpG_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}.NK7xpG_messageImagesPreview{gap:6px;margin:6px 14px 8px}.NK7xpG_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}.NK7xpG_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}.NK7xpG_assistantToolCalls li{min-width:0}.NK7xpG_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}.NK7xpG_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.NK7xpG_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.NK7xpG_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}.NK7xpG_assistantToolCallButton:hover .NK7xpG_assistantToolCallIcon,.NK7xpG_assistantToolCallButton:focus-visible .NK7xpG_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}.NK7xpG_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}.NK7xpG_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}.NK7xpG_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.NK7xpG_systemPrompt{box-sizing:border-box}.NK7xpG_toolCatalog{min-height:100%;padding:8px 0 16px}.NK7xpG_toolCatalogItem{border-bottom:1px solid var(--dsw-alias-border-l1)}.NK7xpG_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}.NK7xpG_toolCatalogSummary::-webkit-details-marker{display:none}.NK7xpG_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}.NK7xpG_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.NK7xpG_toolCatalogChevron,.NK7xpG_toolCatalogIcon{color:var(--dsw-alias-label-caption)}.NK7xpG_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}.NK7xpG_toolCatalogItem[open] .NK7xpG_toolCatalogChevron{transform:rotate(90deg)}.NK7xpG_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}.NK7xpG_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.NK7xpG_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}.NK7xpG_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}.NK7xpG_toolCatalogTree{margin-left:-14px;margin-right:6px}.NK7xpG_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}.NK7xpG_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}.NK7xpG_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.NK7xpG_overviewPreview .NK7xpG_noPayload{padding:6px 14px 8px}.NK7xpG_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){.NK7xpG_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"historyLoadButton": "NK7xpG_historyLoadButton",
			"collapsedTurnEllipsis": "NK7xpG_collapsedTurnEllipsis",
			"inlineResultText": "NK7xpG_inlineResultText",
			"assistantToolCallsPreview": "NK7xpG_assistantToolCallsPreview",
			"collapsedTurnContent": "NK7xpG_collapsedTurnContent",
			"toolCatalogTree": "NK7xpG_toolCatalogTree",
			"split": "NK7xpG_split",
			"sourceBlockHeader": "NK7xpG_sourceBlockHeader",
			"noOutputText": "NK7xpG_noOutputText",
			"detailsResizeHandle": "NK7xpG_detailsResizeHandle",
			"historyLoading": "NK7xpG_historyLoading",
			"turnRail": "NK7xpG_turnRail",
			"promptDiffSections": "NK7xpG_promptDiffSections",
			"overviewSection": "NK7xpG_overviewSection",
			"detailTab": "NK7xpG_detailTab",
			"toolCatalogFullDescription": "NK7xpG_toolCatalogFullDescription",
			"noPayload": "NK7xpG_noPayload",
			"toolCatalogChevron": "NK7xpG_toolCatalogChevron",
			"promptDiffLinecontext": "NK7xpG_promptDiffLinecontext",
			"assistantToolCallButton": "NK7xpG_assistantToolCallButton",
			"toolCatalogDefinition": "NK7xpG_toolCatalogDefinition",
			"schemaParametersTitle": "NK7xpG_schemaParametersTitle",
			"messageImages": "NK7xpG_messageImages",
			"messageImagesPreview": "NK7xpG_messageImagesPreview",
			"kindTagIcon": "NK7xpG_kindTagIcon",
			"compactedSummary": "NK7xpG_compactedSummary",
			"assistantToolCalls": "NK7xpG_assistantToolCalls",
			"jsonPayload": "NK7xpG_jsonPayload",
			"kindTag": "NK7xpG_kindTag",
			"promptDiffSection": "NK7xpG_promptDiffSection",
			"systemPrompt": "NK7xpG_systemPrompt",
			"markdownPayload": "NK7xpG_markdownPayload",
			"contentText": "NK7xpG_contentText",
			"resultPreview": "NK7xpG_resultPreview",
			"markdownPreview": "NK7xpG_markdownPreview",
			"assistantToolCallArgs": "NK7xpG_assistantToolCallArgs",
			"eventHeader": "NK7xpG_eventHeader",
			"overviewTitleIcon": "NK7xpG_overviewTitleIcon",
			"promptDiffTitle": "NK7xpG_promptDiffTitle",
			"schemaDescription": "NK7xpG_schemaDescription",
			"contextGreen": "NK7xpG_contextGreen",
			"sourceBlockContent": "NK7xpG_sourceBlockContent",
			"requestBoundaryControl": "NK7xpG_requestBoundaryControl",
			"promptDiff": "NK7xpG_promptDiff",
			"eventColumn": "NK7xpG_eventColumn",
			"overviewHierarchyNavLink": "NK7xpG_overviewHierarchyNavLink",
			"overviewTitle": "NK7xpG_overviewTitle",
			"thinkingToggle": "NK7xpG_thinkingToggle",
			"overviewHeading": "NK7xpG_overviewHeading",
			"visuallyHidden": "NK7xpG_visuallyHidden",
			"toolCallNameTypeface": "NK7xpG_toolCallNameTypeface",
			"sourceBlock": "NK7xpG_sourceBlock",
			"payload": "NK7xpG_payload",
			"toolCatalogItem": "NK7xpG_toolCatalogItem",
			"overviewPreview": "NK7xpG_overviewPreview",
			"turnLabelFull": "NK7xpG_turnLabelFull",
			"schemaTree": "NK7xpG_schemaTree",
			"promptDiffLineremoved": "NK7xpG_promptDiffLineremoved",
			"inlineResult": "NK7xpG_inlineResult",
			"toolCallPayload": "NK7xpG_toolCallPayload",
			"arrow": "NK7xpG_arrow",
			"requestDetailsDot": "NK7xpG_requestDetailsDot",
			"usagePanel": "NK7xpG_usagePanel",
			"assistantToolCallName": "NK7xpG_assistantToolCallName",
			"resultBlocks": "NK7xpG_resultBlocks",
			"toolCatalogName": "NK7xpG_toolCatalogName",
			"toolCatalog": "NK7xpG_toolCatalog",
			"panelImageLinkPreview": "NK7xpG_panelImageLinkPreview",
			"sourceBlockLabel": "NK7xpG_sourceBlockLabel",
			"assistantContent": "NK7xpG_assistantContent",
			"historyLoadingBar": "NK7xpG_historyLoadingBar",
			"assistantContentRendered": "NK7xpG_assistantContentRendered",
			"content": "NK7xpG_content",
			"historyLoadRow": "NK7xpG_historyLoadRow",
			"subtoolAmber": "NK7xpG_subtoolAmber",
			"summaryScrollRegion": "NK7xpG_summaryScrollRegion",
			"contentColumn": "NK7xpG_contentColumn",
			"toolCallOnly": "NK7xpG_toolCallOnly",
			"requestDetailsName": "NK7xpG_requestDetailsName",
			"overviewParentLinks": "NK7xpG_overviewParentLinks",
			"compacted": "NK7xpG_compacted",
			"overviewSections": "NK7xpG_overviewSections",
			"usageGroup": "NK7xpG_usageGroup",
			"usageHeading": "NK7xpG_usageHeading",
			"panelImageLink": "NK7xpG_panelImageLink",
			"panelImage": "NK7xpG_panelImage",
			"turnLabelActive": "NK7xpG_turnLabelActive",
			"selectionRail": "NK7xpG_selectionRail",
			"jsonPreview": "NK7xpG_jsonPreview",
			"thinkingQuote": "NK7xpG_thinkingQuote",
			"eventInner": "NK7xpG_eventInner",
			"assistantVioletBright": "NK7xpG_assistantVioletBright",
			"requestTokenDetail": "NK7xpG_requestTokenDetail",
			"toolCatalogIcon": "NK7xpG_toolCatalogIcon",
			"sourceBlockJumpIcon": "NK7xpG_sourceBlockJumpIcon",
			"promptDiffLinemeta": "NK7xpG_promptDiffLinemeta",
			"historyLoadingSpinner": "NK7xpG_historyLoadingSpinner",
			"schemaName": "NK7xpG_schemaName",
			"event": "NK7xpG_event",
			"kindSlot": "NK7xpG_kindSlot",
			"message": "NK7xpG_message",
			"turnLabel": "NK7xpG_turnLabel",
			"toolAmber": "NK7xpG_toolAmber",
			"thinkingChevron": "NK7xpG_thinkingChevron",
			"user": "NK7xpG_user",
			"schema": "NK7xpG_schema",
			"resultBlocksPreview": "NK7xpG_resultBlocksPreview",
			"kindTagLabel": "NK7xpG_kindTagLabel",
			"detailsHeader": "NK7xpG_detailsHeader",
			"timestampToggle": "NK7xpG_timestampToggle",
			"schemaIntro": "NK7xpG_schemaIntro",
			"details": "NK7xpG_details",
			"resultBlockText": "NK7xpG_resultBlockText",
			"close": "NK7xpG_close",
			"turnLabelCompact": "NK7xpG_turnLabelCompact",
			"errorPayload": "NK7xpG_errorPayload",
			"resultRequest": "NK7xpG_resultRequest",
			"detailsLocation": "NK7xpG_detailsLocation",
			"sourceBlockJumpTarget": "NK7xpG_sourceBlockJumpTarget",
			"assistantToolCallText": "NK7xpG_assistantToolCallText",
			"schemaParameters": "NK7xpG_schemaParameters",
			"sourceBlocks": "NK7xpG_sourceBlocks",
			"collapsedTurnText": "NK7xpG_collapsedTurnText",
			"table": "NK7xpG_table",
			"thinkingQuoteOnlyPreview": "NK7xpG_thinkingQuoteOnlyPreview",
			"overviewHierarchyJumpIconTight": "NK7xpG_overviewHierarchyJumpIconTight",
			"systemNeutral": "NK7xpG_systemNeutral",
			"virtualSpacer": "NK7xpG_virtualSpacer",
			"overview": "NK7xpG_overview",
			"detailTabActive": "NK7xpG_detailTabActive",
			"history-loading-spin": "NK7xpG_history-loading-spin",
			"schemaPreview": "NK7xpG_schemaPreview",
			"payloadPreview": "NK7xpG_payloadPreview",
			"trajectory-table": "NK7xpG_trajectory-table",
			"promptDiffLineadded": "NK7xpG_promptDiffLineadded",
			"detailsTitle": "NK7xpG_detailsTitle",
			"detailTabs": "NK7xpG_detailTabs",
			"assistantToolCallIcon": "NK7xpG_assistantToolCallIcon",
			"toolCatalogSummary": "NK7xpG_toolCatalogSummary",
			"error": "NK7xpG_error",
			"assistantOutput": "NK7xpG_assistantOutput",
			"detailBodySummary": "NK7xpG_detailBodySummary",
			"toolCatalogDescription": "NK7xpG_toolCatalogDescription",
			"requestBoundaryControlActive": "NK7xpG_requestBoundaryControlActive",
			"tablePane": "NK7xpG_tablePane",
			"detailBody": "NK7xpG_detailBody"
		};
		//#endregion
		//#region packages/client/ui-trajectory/src/client/TrajectoryTable.tsx
		...
		function promptDiffLines(before, after) {
			return (0, import_libcjs.structuredPatch)("", "", before, after, void 0, void 0, { context: 3 }).hunks.flatMap((hunk, hunkIndex) => [
				...hunkIndex === 0 ? [] : [{
					kind: "meta",
					text: ""
				}],
		...
		*/
		function TrajectoryTable({ requestNumbers: sessionRequestNumbers, turns, streamingCells = [], timelineFocusIndexes = null, searchMatchIndexes = null, onSelectedIndexChange, onRecordSelect, recordSelection = null, recordFocus = null, historyLoading = false, olderHistoryLoading = false, historyStartSeq, hasOlderRecords = false, onLoadOlder, onClearSelection, collapsedTurns, onToggleTurn, collapsedAssistants, onToggleAssistant, inspectCallId = null, onInspectApplied }) {
			...
			const rowVirtualizer = (0, import_cjs.useVirtualizer)({
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-trajectory/src/client/TrajectoryToolbar.module.css.mjs
		const css$2 = ".EITuwW_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}.EITuwW_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}.EITuwW_actions{flex:none;align-items:center;gap:2px;display:flex}.EITuwW_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}.EITuwW_toggle:hover,.EITuwW_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.EITuwW_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.EITuwW_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}.EITuwW_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.EITuwW_control[hidden]{display:none}.EITuwW_control:hover:not(:disabled),.EITuwW_control[aria-checked=true],.EITuwW_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}.EITuwW_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.EITuwW_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.EITuwW_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}.EITuwW_controlThumb{background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}.EITuwW_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}.EITuwW_controlTrack[data-on=true] .EITuwW_controlThumb{transform:translate(10px)}.EITuwW_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.EITuwW_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.EITuwW_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.EITuwW_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}.EITuwW_search{border:1px solid var(--dsw-alias-border-l2);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}.EITuwW_search:hover{border-color:var(--dsw-alias-label-caption)}.EITuwW_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}.EITuwW_searchIcon{flex:none}.EITuwW_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}.EITuwW_searchInput::placeholder{color:var(--dsw-alias-label-caption)}.EITuwW_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"root": "EITuwW_root",
			"inner": "EITuwW_inner",
			"actionIcon": "EITuwW_actionIcon",
			"actions": "EITuwW_actions",
			"controlTrack": "EITuwW_controlTrack",
			"toggle": "EITuwW_toggle",
			"search": "EITuwW_search",
			"searchIcon": "EITuwW_searchIcon",
			"searchInput": "EITuwW_searchInput",
			"toggleIcon": "EITuwW_toggleIcon",
			"control": "EITuwW_control",
			"controlThumb": "EITuwW_controlThumb",
			"action": "EITuwW_action"
		};
		//#endregion
		//#region packages/client/ui-trajectory/src/client/TrajectoryToolbar.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-trajectory/src/client/timeline.ts
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-trajectory/src/client/TrajectoryTimeline.module.css.mjs
		const css$1 = ".pyjw4G_root{z-index:1;isolation:isolate;border-bottom:1px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}.pyjw4G_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}.pyjw4G_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}.pyjw4G_labels{border-right:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}.pyjw4G_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}.pyjw4G_labels span:first-child{top:7px}.pyjw4G_labels span:nth-child(2){top:21px}.pyjw4G_labels span:nth-child(3){top:35px}.pyjw4G_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}.pyjw4G_track[data-panning=true]{cursor:grabbing}.pyjw4G_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}.pyjw4G_earlierHistory:hover{opacity:1}.pyjw4G_earlierHistory[aria-disabled=true]{cursor:default}.pyjw4G_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.pyjw4G_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.pyjw4G_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.pyjw4G_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}.pyjw4G_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){.pyjw4G_lanes[data-animate-viewport=true],.pyjw4G_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}.pyjw4G_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:1px;position:absolute}.pyjw4G_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}.pyjw4G_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}.pyjw4G_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}.pyjw4G_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}.pyjw4G_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}.pyjw4G_span[data-timeline-span=tool],.pyjw4G_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}.pyjw4G_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}.pyjw4G_span[data-equal-duration=true]{width:8px;min-width:8px}.pyjw4G_span[data-selected=false]{opacity:.2}.pyjw4G_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}.pyjw4G_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}.pyjw4G_span[data-search-match=false]{opacity:.14}.pyjw4G_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}.pyjw4G_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}.pyjw4G_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}.pyjw4G_selectionEdges:before,.pyjw4G_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}.pyjw4G_selectionEdges:before{left:0}.pyjw4G_selectionEdges:after{right:0}.pyjw4G_selectionEdges[data-dragging=true]:before,.pyjw4G_selectionEdges[data-dragging=true]:after{width:2px}.pyjw4G_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"selection": "pyjw4G_selection",
			"track": "pyjw4G_track",
			"turnBoundary": "pyjw4G_turnBoundary",
			"labels": "pyjw4G_labels",
			"earlierHistory": "pyjw4G_earlierHistory",
			"lanes": "pyjw4G_lanes",
			"root": "pyjw4G_root",
			"plot": "pyjw4G_plot",
			"empty": "pyjw4G_empty",
			"turnBoundaries": "pyjw4G_turnBoundaries",
			"span": "pyjw4G_span",
			"selectionEdges": "pyjw4G_selectionEdges",
			"hoverLine": "pyjw4G_hoverLine"
		};
		//#endregion
		//#region packages/client/ui-trajectory/src/client/TrajectoryTimeline.tsx
		...
		//#endregion
		//#region packages/client/ui-trajectory/src/client/layout.ts
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-trajectory/src/client/trajectory-search-index.ts
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-trajectory/src/client/views.module.css.mjs
		const css = ".hMBrya_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}.hMBrya_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
		...
		var views_module_css_default = {
			"ledger": "hMBrya_ledger",
			"root": "hMBrya_root"
		};
		//#endregion
		//#region packages/client/ui-trajectory/src/client/TrajectoryView.tsx
		...
		//#endregion
		//#region packages/client/ui-trajectory/src/client/index.ts
