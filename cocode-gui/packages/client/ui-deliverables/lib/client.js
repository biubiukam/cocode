window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region packages/client/ui-deliverables/src/client/turn-deliverables.ts
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-deliverables/src/client/ProducedFiles.module.css.mjs
		const css = ".MWjcsa_root{grid-template-columns:max-content minmax(0,1fr);align-items:center;gap:6px 8px;margin-top:16px;font-size:13px;line-height:22px;display:grid;position:relative}.MWjcsa_label{color:var(--dsw-alias-label-tertiary);grid-area:1/1}.MWjcsa_row{flex-wrap:nowrap;grid-area:1/2;align-items:center;gap:8px;min-width:0;display:flex;overflow:hidden}.MWjcsa_file{text-overflow:ellipsis;white-space:nowrap;background:var(--dsw-alias-interactive-bg-hover);max-width:320px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:none;border-radius:6px;flex:none;margin:0;padding:0 8px;overflow:hidden}.MWjcsa_file:hover{color:var(--dsw-alias-state-business-primary);text-decoration:underline}.MWjcsa_file:focus-visible,.MWjcsa_showFolder:focus-visible{box-shadow:inset 0 0 0 2px var(--dsw-alias-state-business-primary);outline:none}.MWjcsa_more{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none}.MWjcsa_showFolder{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:4px;grid-area:2/2;justify-self:start;margin:0;padding:0 2px;line-height:20px}.MWjcsa_showFolder:hover{color:var(--dsw-alias-label-secondary);text-decoration:underline}.MWjcsa_measure{visibility:hidden;pointer-events:none;contain:strict;width:0;height:0;position:absolute;overflow:hidden}.MWjcsa_probe{width:max-content;position:absolute;inset:0 auto auto 0}";
		...
		var ProducedFiles_module_css_default = {
			"row": "MWjcsa_row",
			"measure": "MWjcsa_measure",
			"showFolder": "MWjcsa_showFolder",
			"root": "MWjcsa_root",
			"probe": "MWjcsa_probe",
			"label": "MWjcsa_label",
			"file": "MWjcsa_file",
		...
		//#endregion
		//#region packages/client/ui-deliverables/src/client/ProducedFiles.tsx
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-deliverables/src/client/locales.ts
		...
		//#endregion
		//#region packages/client/ui-deliverables/src/client/index.ts
