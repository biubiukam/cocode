window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$3 = "._4q77W_trigger{box-sizing:border-box;cursor:pointer;width:calc(100% + 8px);height:34px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:12px;flex:none;align-items:center;gap:8px;margin:4px -4px;padding:6px 2px 6px 10px;font-family:inherit;font-size:14px;line-height:22px;display:flex;overflow:hidden}._4q77W_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}._4q77W_trigger._4q77W_rail{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;margin:8px 0 10px;padding:0}._4q77W_triggerLabel{white-space:nowrap;overflow:hidden}._4q77W_overlay{z-index:1000;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}._4q77W_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}._4q77W_panel{z-index:1;background:var(--dsw-alias-bg-layer-2);width:800px;max-width:calc(100vw - 48px);height:min(800px,100vh - 48px);box-shadow:var(--dsw-shadow-lv3);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:24px;display:flex;position:relative;overflow:hidden}._4q77W_nav{box-sizing:border-box;flex-direction:column;flex:none;gap:18px;width:188px;padding:22px 12px 0;display:flex}._4q77W_navTitle{color:var(--dsw-alias-label-primary);padding:0 12px;font-size:16px;font-weight:500;line-height:24px}._4q77W_navList{flex-direction:column;gap:4px;display:flex}._4q77W_navCell{box-sizing:border-box;cursor:pointer;height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:9px 16px 9px 12px;font-family:inherit;font-size:14px;font-weight:400;line-height:22px;display:flex}._4q77W_navCell:hover{background:var(--dsw-specific-sidebar-nav-item-hover)}._4q77W_navCell._4q77W_active{background:var(--dsw-specific-sidebar-nav-item-active)}._4q77W_navIcon{flex:none}._4q77W_navLabel{white-space:nowrap;text-overflow:ellipsis;flex:1;min-width:0;overflow:hidden}._4q77W_content{flex-direction:column;flex:1;min-width:0;display:flex}._4q77W_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:flex-start;gap:8px;height:54px;padding:20px 14px 8px 10px;display:flex}._4q77W_actions{justify-content:flex-end;align-items:center;gap:8px;min-width:0;margin-left:auto;display:flex}._4q77W_close{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:0;display:inline-flex}._4q77W_close:hover{background:var(--dsw-alias-interactive-bg-hover)}._4q77W_options{flex:1;min-height:0;padding:0 24px 24px;overflow-y:auto}._4q77W_hiddenLabel{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var SettingsRoot_module_css_default = {
			"rail": "_4q77W_rail",
			"navLabel": "_4q77W_navLabel",
			"triggerLabel": "_4q77W_triggerLabel",
			"overlay": "_4q77W_overlay",
			"header": "_4q77W_header",
			"close": "_4q77W_close",
			"trigger": "_4q77W_trigger",
			"navIcon": "_4q77W_navIcon",
			"actions": "_4q77W_actions",
			"active": "_4q77W_active",
			"mask": "_4q77W_mask",
			"navCell": "_4q77W_navCell",
			"navList": "_4q77W_navList",
			"navTitle": "_4q77W_navTitle",
			"options": "_4q77W_options",
			"hiddenLabel": "_4q77W_hiddenLabel",
			"content": "_4q77W_content",
			"panel": "_4q77W_panel",
			"nav": "_4q77W_nav"
		};
		//#endregion
		...
		*/
		...
		const css$2 = ".c4zsrW_triggerLabel{white-space:nowrap;overflow:hidden}";
		...
		var chrome_module_css_default = { "triggerLabel": "c4zsrW_triggerLabel" };
		//#endregion
		...
		*/
		...
		const css$1 = ".JgbFMq_section{flex-direction:column;width:100%;display:flex}.JgbFMq_section>[data-slot=\"settings.general.item\"]>:last-child{border-bottom:none}";
		...
		var GeneralSection_module_css_default = { "section": "JgbFMq_section" };
		//#endregion
		...
		*/
		...
		const css = ".fOcXXG_action{align-items:center;gap:8px;min-width:0;display:flex}.fOcXXG_error{max-width:180px;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}";
