...
export const zh = {
  'group.ungrouped': '未分组',
  'group.recent': '最近对话',
  'settings.storage.title': '最近对话存储空间',
  'settings.storage.description': '未选择项目时，新会话会使用此文件夹。',
  'settings.storage.choose': '选择文件夹',
  'settings.storage.systemDefault': '系统默认位置',
  'session.new': '新会话',
  ...
  'menu.archiveReadSessions': '归档已读会话',
  'menu.archiveReadSessions.pending': '正在归档…',
  'sessions.count.one': '{n} 个会话',
  'sessions.count.other': '{n} 个会话',
  'actions.workspace.aria': '工作区“{name}”的操作',
  'actions.recent.aria': '最近对话操作',
...
export const en = {
  ...
  'group.recent': 'Recent chats',
  'settings.storage.title': 'Recent chats storage',
  'settings.storage.description': 'New chats without a project use this folder.',
  'settings.storage.choose': 'Choose folder',
  'settings.storage.systemDefault': 'System default',
  ...
  'menu.archiveReadSessions': 'Archive read sessions',
  'menu.archiveReadSessions.pending': 'Archiving…',
  'sessions.count.one': '{n} session',
  'sessions.count.other': '{n} sessions',
  'actions.workspace.aria': 'Workspace actions for {name}',
  'actions.recent.aria': 'Recent chats actions',
