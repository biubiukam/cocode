window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-layout/src/client/AppFrame.module.css.mjs
		const css = ".sibnGG_frame{background:var(--dsw-alias-bg-base);height:100%;transition:grid-template-columns var(--ds-transition-duration-slow) var(--ds-ease-in-out);grid-template-rows:100%;display:grid;position:relative;overflow:hidden}.sibnGG_frame[data-dragging]{transition:none}@media (prefers-reduced-motion:reduce){.sibnGG_frame{transition:none}}.sibnGG_sidebarCol{background:var(--dsw-specific-sidebar-fill);border-right:1px solid var(--dsw-alias-border-l1);min-width:0;overflow:hidden}.sibnGG_centerCol{flex-direction:column;min-width:0;display:flex;overflow:hidden}.sibnGG_detailsCol{border-left:1px solid var(--dsw-alias-border-l2);min-width:0;overflow:hidden}.sibnGG_frame[data-details-collapsed] .sibnGG_detailsCol{border-left:none}.sibnGG_handle{cursor:col-resize;z-index:2;touch-action:none;width:8px;transition:left var(--ds-transition-duration-slow) var(--ds-ease-in-out);margin-left:-4px;position:absolute;top:0;bottom:0}.sibnGG_frame[data-dragging] .sibnGG_handle{transition:none}@media (prefers-reduced-motion:reduce){.sibnGG_handle{transition:none}}.sibnGG_handle[data-side=details]:after{content:\"\";box-sizing:border-box;background:var(--dsw-alias-button-floating-fill);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);opacity:0;width:12px;height:32px;transition:opacity var(--ds-transition-duration-slow) var(--ds-ease-in-out), background var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:10px;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.sibnGG_detailsCol:hover~.sibnGG_handle[data-side=details]:after,.sibnGG_handle[data-side=details]:hover:after,.sibnGG_handle[data-side=details][data-dragging=true]:after{opacity:1}.sibnGG_handle[data-side=details]:hover:after,.sibnGG_handle[data-side=details][data-dragging=true]:after{background:var(--dsw-alias-button-floating-hover);border-color:var(--dsw-alias-border-l3)}.sibnGG_overlayLayer{z-index:20;pointer-events:none;position:absolute;inset:0}.sibnGG_overlayLayer>*{pointer-events:auto}";
		...
		var AppFrame_module_css_default = {
			"frame": "sibnGG_frame",
			"detailsCol": "sibnGG_detailsCol",
			"handle": "sibnGG_handle",
			"sidebarCol": "sibnGG_sidebarCol",
			"overlayLayer": "sibnGG_overlayLayer",
			"centerCol": "sibnGG_centerCol"
		};
		//#endregion
		//#region packages/client/ui-layout/src/client/AppFrame.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-layout/src/client/stores.ts
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-layout/src/client/service.ts
		...
		//#endregion
		//#region packages/client/ui-layout/src/client/theme-presenter.ts
		...
		//#endregion
		//#region packages/client/ui-layout/src/client/index.ts
