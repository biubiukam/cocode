window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-settings-plugins/src/client/fields.module.css.mjs
		const css$2 = "._2sw4UG_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}._2sw4UG_field+._2sw4UG_field{border-top:1px solid var(--dsw-alias-border-l2)}._2sw4UG_head{align-items:center;gap:8px;display:flex}._2sw4UG_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}._2sw4UG_badges{align-items:center;gap:8px;display:inline-flex}._2sw4UG_badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}._2sw4UG_badgeMuted{white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}._2sw4UG_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}._2sw4UG_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}._2sw4UG_reset:disabled{cursor:default}._2sw4UG_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}._2sw4UG_input:focus-visible{border-color:var(--dsw-alias-state-business-primary);outline:none}._2sw4UG_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}._2sw4UG_inputInvalid{border-color:var(--dsw-alias-label-error);}._2sw4UG_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}._2sw4UG_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			"field": "_2sw4UG_field",
			"badgeMuted": "_2sw4UG_badgeMuted",
			"inputInvalid": "_2sw4UG_inputInvalid",
			"input": "_2sw4UG_input",
			"reset": "_2sw4UG_reset",
			"label": "_2sw4UG_label",
			"badge": "_2sw4UG_badge",
			"head": "_2sw4UG_head",
			"hint": "_2sw4UG_hint",
			"badges": "_2sw4UG_badges",
			"invalid": "_2sw4UG_invalid"
		};
		//#endregion
		//#region packages/client/ui-settings-plugins/src/client/fields.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-settings-plugins/src/client/PluginCard.module.css.mjs
		const css$1 = ".gYw1ba_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.gYw1ba_card:hover{border-color:var(--dsw-alias-label-dimmed)}.gYw1ba_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.gYw1ba_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.gYw1ba_header:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.gYw1ba_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.gYw1ba_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.gYw1ba_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.gYw1ba_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.gYw1ba_chevronOpen{transform:rotate(180deg)}.gYw1ba_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}.gYw1ba_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}.gYw1ba_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.gYw1ba_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.gYw1ba_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}.gYw1ba_discard,.gYw1ba_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.gYw1ba_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.gYw1ba_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.gYw1ba_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.gYw1ba_discard:disabled,.gYw1ba_save:disabled{opacity:.4;cursor:default}.gYw1ba_discard:focus-visible,.gYw1ba_save:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"name": "gYw1ba_name",
			"chevronOpen": "gYw1ba_chevronOpen",
			"discard": "gYw1ba_discard",
			"description": "gYw1ba_description",
			"body": "gYw1ba_body",
			"footer": "gYw1ba_footer",
			"card": "gYw1ba_card",
			"failed": "gYw1ba_failed",
			"cardOpen": "gYw1ba_cardOpen",
			"headText": "gYw1ba_headText",
			"chevron": "gYw1ba_chevron",
			"readOnly": "gYw1ba_readOnly",
			"save": "gYw1ba_save",
			"header": "gYw1ba_header",
			"pending": "gYw1ba_pending"
		};
		//#endregion
		//#region packages/client/ui-settings-plugins/src/client/PluginCard.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-settings-plugins/src/client/AgentLoopCard.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-settings-plugins/src/client/BashCard.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/electron-template/packages/client/ui-settings-plugins/src/client/PluginsSettingsSection.module.css.mjs
		const css = ".NVH1Ha_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.NVH1Ha_heading{margin:0;font-size:18px;font-weight:600}.NVH1Ha_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.NVH1Ha_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}.NVH1Ha_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}.NVH1Ha_tab:hover,.NVH1Ha_tab[data-active=true]{color:var(--dsw-alias-label-primary)}.NVH1Ha_tab[data-active=true]:after,.NVH1Ha_tab:focus-visible:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.NVH1Ha_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-state-business-primary);border-radius:2px}.NVH1Ha_panel{min-width:0;padding-top:2px}.NVH1Ha_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}.NVH1Ha_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			"tabs": "NVH1Ha_tabs",
			"section": "NVH1Ha_section",
			"empty": "NVH1Ha_empty",
			"intro": "NVH1Ha_intro",
			"cards": "NVH1Ha_cards",
			"panel": "NVH1Ha_panel",
			"heading": "NVH1Ha_heading",
			"tab": "NVH1Ha_tab"
		};
		//#endregion
		//#region packages/client/ui-settings-plugins/src/client/ConfigurablePluginsTab.tsx
		...
		//#endregion
		//#region packages/client/ui-settings-plugins/src/client/PluginsSettingsSection.tsx
		...
		//#endregion
		//#region packages/client/ui-settings-plugins/src/client/WebSearchCard.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-settings-plugins/src/client/card-form.ts
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-settings-plugins/src/client/agent-loop-card-controller.ts
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-settings-plugins/src/client/bash-card-controller.ts
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-settings-plugins/src/client/web-search-card-controller.ts
		/**
		...
		*/
		...
		//#endregion
		//#region packages/client/ui-settings-plugins/src/client/locales.ts
		/** English copy. */
		const en = {
			nav: "Plugins",
			title: "Plugins",
		...
		//#endregion
		//#region packages/client/ui-settings-plugins/src/client/index.ts
