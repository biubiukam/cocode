window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/kambiu/worker/open/deepseek-harness/packages/client/ui-subagent/src/client/SubagentCatalogAction.module.css.mjs
		const css$1 = "._1AKajG_root{position:relative}._1AKajG_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}._1AKajG_count{margin:0 5px}._1AKajG_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}._1AKajG_trigger:hover,._1AKajG_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}._1AKajG_trigger svg{transition:transform .12s}._1AKajG_triggerOpen{transform:rotate(180deg)}._1AKajG_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}._1AKajG_node{min-width:0;position:relative}._1AKajG_menu>._1AKajG_node{margin-left:-3px}._1AKajG_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}._1AKajG_row:hover>._1AKajG_clickarea,._1AKajG_row:focus-visible>._1AKajG_clickarea{background:var(--dsw-alias-interactive-bg-hover)}._1AKajG_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}._1AKajG_row>[data-state],._1AKajG_clickarea>[data-state]{margin-top:4px}._1AKajG_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}._1AKajG_disabled:hover{background:0 0}._1AKajG_loadingRow{cursor:default}._1AKajG_disclosure,._1AKajG_disclosureSpace{flex:none;width:14px;height:18px}._1AKajG_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}._1AKajG_disclosure:hover{color:var(--dsw-alias-label-primary)}._1AKajG_disclosureOpen{transform:rotate(90deg)}._1AKajG_content{flex-direction:column;flex:1;min-width:0;display:flex}._1AKajG_label,._1AKajG_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._1AKajG_label{color:inherit;font-weight:400}._1AKajG_summary,._1AKajG_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}._1AKajG_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex:none;grid-template-rows:18px 16px;display:grid}._1AKajG_metricToken{grid-row:1;line-height:18px}._1AKajG_metricDuration{grid-row:2}._1AKajG_children{margin-left:18px;padding-left:4px;position:relative}._1AKajG_children:before,._1AKajG_children>._1AKajG_node:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;left:0}._1AKajG_children:before{height:26px;top:-26px}._1AKajG_children[aria-busy=true]:before{content:none}._1AKajG_children>._1AKajG_node:before{top:0;bottom:0;left:-4px}._1AKajG_children>._1AKajG_node:last-child:before{height:17px;bottom:auto}._1AKajG_children>._1AKajG_node>._1AKajG_row:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}._1AKajG_notice,._1AKajG_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}._1AKajG_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}._1AKajG_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}._1AKajG_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentCatalogAction_module_css_default = {
			"row": "_1AKajG_row",
			"count": "_1AKajG_count",
			"disclosureOpen": "_1AKajG_disclosureOpen",
			"metricDuration": "_1AKajG_metricDuration",
			"label": "_1AKajG_label",
			"children": "_1AKajG_children",
			"refresh": "_1AKajG_refresh",
			"disabled": "_1AKajG_disabled",
			"clickarea": "_1AKajG_clickarea",
			"triggerOpen": "_1AKajG_triggerOpen",
			"content": "_1AKajG_content",
			"metricToken": "_1AKajG_metricToken",
			"activitySlot": "_1AKajG_activitySlot",
			"node": "_1AKajG_node",
			"loadingRow": "_1AKajG_loadingRow",
			"disclosure": "_1AKajG_disclosure",
			"notice": "_1AKajG_notice",
			"error": "_1AKajG_error",
			"summary": "_1AKajG_summary",
			"metrics": "_1AKajG_metrics",
			"trigger": "_1AKajG_trigger",
			"root": "_1AKajG_root",
			"menu": "_1AKajG_menu",
			"disclosureSpace": "_1AKajG_disclosureSpace"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/kambiu/worker/open/deepseek-harness/packages/client/ui-subagent/src/client/SubagentReadOnlyComposer.module.css.mjs
		const css = "._1A4deW_frame{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-height:54px;color:var(--dsw-alias-label-tertiary);border-radius:14px;justify-content:center;align-items:center;gap:8px;margin:0 24px 20px;padding:10px 16px;font-size:13px;line-height:20px;display:flex}._1A4deW_frame strong{color:var(--dsw-alias-label-primary);font-weight:510}";
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "_1A4deW_frame" };
		//#endregion
