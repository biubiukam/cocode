...
/**
 * Display transform for host-configured names outside the built-in preset set.
 */
...
function optionLabel(
  ...
  return localizedPresetLabel(t, option.value, option.name)
}
...
function valueLabel(
  ...
  return localizedPresetLabel(t, value, name)
}

/** Built-in presets map to `access.preset.*` keys in the conversation dictionary. */
        ...
        anchor={
          <button
            ...
            aria-label={t('input.accessMode', {
              name: current === undefined
                ? valueLabel(currentValue, currentValue, t)
          ...
          >
            ...
            <span className={css.triggerLabel}>
              {current === undefined ? valueLabel(currentValue, currentValue, t) : optionLabel(current, t)}
            </span>
