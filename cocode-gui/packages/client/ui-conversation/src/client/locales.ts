...
export const zh = {
  ...
  'placeholder.default': '规划与构建，@ 引用文件和上下文，/ 执行技能与命令',
  ...
  'access.confirm.description': '启用完全权限后，智能体将减少确认步骤，并可直接执行更多操作，包括敏感操作、文件修改或外部命令。仅建议在你信任当前任务时使用。',
  'access.confirm.acknowledge': '我已了解风险，并愿意继续',
  'access.confirm.cancel': '取消',
  'access.confirm.enable': '启用完全权限',
  'access.preset.read-only': '只读',
  'access.preset.workspace-write': '工作区可写',
  'access.preset.danger-full-access': '完全权限',
  'hero.headline': '今天我们一起创造些什么呢？',
  'hero.preview': '预览版',
  'hero.chooseWorkspace': '选择工作区',
  'hero.clearWorkspace': '取消选择工作区',
  'hero.defaultWorkspace': '最近对话',
  ...
  'error.outcomeUnknown': '运行状态未知：请先刷新会话状态，确认后再重试。',
  ...
  'search.summary.truncated': '显示 {shown} / 共 {total}',
  'search.empty': '无结果',
...
export const en = {
  ...
  'placeholder.default': 'Plan, Build, @ for files and context, / for skills and command',
  ...
  'access.preset.read-only': 'Read Only',
  'access.preset.workspace-write': 'Workspace Write',
  'access.preset.danger-full-access': 'Full access',
  'hero.headline': 'What shall we create together today?',
  'hero.preview': 'Preview',
  'hero.chooseWorkspace': 'Choose workspace',
  'hero.clearWorkspace': 'Clear workspace selection',
  'hero.defaultWorkspace': 'Recent chats',
  ...
  'error.outcomeUnknown': 'The run state is unknown. Refresh the session state before trying again.',
  ...
  'read.showing': 'Showing {shown} / {total} lines',
  ...
  'search.summary.truncated': 'Showing {shown} / {total}',
