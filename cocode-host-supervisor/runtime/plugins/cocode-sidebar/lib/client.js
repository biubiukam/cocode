window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const tagId$3 = "cocode-sidebar/sidebar.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$3) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "cocode-sidebar";
		...
		*/
		...
		const tagId$2 = "cocode-sidebar/SubagentView.module.css";
		...
		*/
		...
		const tagId$1 = "cocode-sidebar/SideCardSection.module.css";
		...
		*/
		...
		const tagId = "cocode-sidebar/layout.css";
