 ...
 */
export declare const SIDEBAR_SERVICE_VERSION = "0.12.1-cocode.0";
/**
 ...
 */
export declare const SIDEBAR_FEATURES: readonly ["badge", "tabLifecycle", "updateTab", "openFile", "targetedOpen", "stateSubscription", "tabMeta", "pluginSettings"];
/**
