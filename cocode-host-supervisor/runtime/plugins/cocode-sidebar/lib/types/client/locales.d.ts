...
export declare const zh: {
    ...
    browserBlockedSelf: string;
    browserInvalid: string;
    browserKeyboard: string;
    browserAgentDriving: string;
    browserDownloaded: string;
    browserDownloadCancel: string;
    browserProfile: string;
    browserGrantGeo: string;
    browserGrantNotify: string;
    browserGrantClipboard: string;
    browserDialogAccept: string;
    browserDialogDismiss: string;
    browserEngineMissing: string;
    browserEngineMissingDesc: string;
    browserEngineInstall: string;
    browserEngineInstalling: string;
    browserEngineFailed: string;
    ...
    settingsBrowserToolsTitle: string;
    settingsBrowserToolsDesc: string;
    settingsBrowserIsolatedTitle: string;
    settingsBrowserIsolatedDesc: string;
    settingsBrowserHeadedTitle: string;
    settingsBrowserHeadedDesc: string;
